    ...
    <div class="container">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h2 class="text-center">游戏管理<small class="small_title">欢迎你 &nbsp;&nbsp; <?php echo $_SESSION['username']?>&nbsp;&nbsp; <a href="Clear_session.php">注销</a></small></h2>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($list as $row) : ?>
                            <tr>
                                ...
                                <td><a href="<?php echo $row['title'].'.html' ?>"><?php echo $row['title'] ?></a></td>
